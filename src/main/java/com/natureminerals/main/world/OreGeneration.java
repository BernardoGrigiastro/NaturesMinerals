...
public class OreGeneration {
	...
	public static int STIBNITEHEIGHT = 256;
	...
	public static ConfiguredFeature <?,?> UVAROVITE_FEATURE = newConfiguredFeature("uvarovite_ore",Feature.ORE.configured(
			new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.UVAROVITE_ORE.get().defaultBlockState(), UVARVEIN)).range(UVARHEIGHT)
			.squared().count(UVARCHUNK));
	public static ConfiguredFeature <?,?> KUNZITE_FEATURE = newConfiguredFeature("kunzite_ore",Feature.ORE.configured(
			new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.KUNZITE_ORE.get().defaultBlockState(), KUNZITEVEIN)).range(KUNZITEHEIGHT)
			.squared().count(KUNZITECHUNK));
	public static ConfiguredFeature <?,?> STIBNITE_FEATURE = newConfiguredFeature("stibnite_ore",Feature.ORE.configured(
			new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, BlockInit.STIBNITE_ORE.get().defaultBlockState(), STIBNITEVEIN)).range(STIBNITEHEIGHT)
			.squared().count(STIBNITECHUNK));
	public static ConfiguredFeature <?,?> ASTRITE_FEATURE = newConfiguredFeature("astrite_ore",Feature.ORE.configured(
			new OreFeatureConfig(END_STONE, BlockInit.ASTRITE_ORE.get().defaultBlockState(), ASTRITEVEIN)).range(ASTRITEHEIGHT)
			.squared().count(ASTRITECHUNK));
